...
import es.upv.epsg.iot_g1_1.AdaptadorPrendasFirestoreUI;
...
import es.upv.epsg.iot_g1_1.NoDisponibleActivity;
import es.upv.epsg.iot_g1_1.Prenda;
import es.upv.epsg.iot_g1_1.databinding.ActivityMainInt2Binding;

public class MainActivity_int2 extends AppCompatActivity {

    ArrayList<Prenda> listaPrendas;
    private ActivityMainInt2Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMainInt2Binding.inflate(getLayoutInflater()); //F
