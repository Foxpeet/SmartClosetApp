...
public class NuevaPrenda_int2 extends AppCompatActivity {
    ...
    public void volverLandingNuevaPrendaInt2 (View view) {
        Intent intent = new Intent(this, LandingPage_int2.class);
        startActivity(intent);
    }

    public void irPagTodasPrendasInt2 () {
        Intent intent = new Intent(this, MainActivity_int2.class);
        startActivity(intent);
    }

    public void nuevaPrendaInt2 () {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nuevaprenda_int2);
