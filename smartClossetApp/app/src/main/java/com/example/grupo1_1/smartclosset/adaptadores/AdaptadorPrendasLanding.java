...
public class AdaptadorPrendasLanding extends RecyclerView.Adapter<AdaptadorPrendasLanding.ViewHolder> {

    ArrayList<Prenda> listaPrendas;
    private LayoutInflater inflater;
    private Context context;

    public AdaptadorPrendasLanding(ArrayList<Prenda> listaPrendas, Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.elemento_lista_landing, null);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(ElementoListaLandingBinding itemView) {
