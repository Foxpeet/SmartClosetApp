...
public class AdaptadorPrendasCalendario extends RecyclerView.Adapter<AdaptadorPrendasCalendario.ViewHolder> {

    ArrayList<Prenda> listaPrendas;
    private LayoutInflater inflater;
    private Context context;

    public AdaptadorPrendasCalendario(ArrayList<Prenda> listaPrendas, Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.elemento_lista_calendario, null);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(ElementoListaCalendarioBinding itemView) {
