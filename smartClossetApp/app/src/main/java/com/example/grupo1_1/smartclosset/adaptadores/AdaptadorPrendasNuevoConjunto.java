...
public class AdaptadorPrendasNuevoConjunto extends RecyclerView.Adapter<AdaptadorPrendasNuevoConjunto.ViewHolder> {

    ArrayList<Prenda> listaPrendas;
    private LayoutInflater inflater;
    private Context context;

    public AdaptadorPrendasNuevoConjunto(ArrayList<Prenda> listaPrendas, Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.elemento_lista_crear_conjunto, null);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(ElementoListaCrearConjuntoBinding itemView) {
