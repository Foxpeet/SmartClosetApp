...
public class LandingPage_int1 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_landing_int1);
    ...
    public void paginaNuevaPrenda(View view) {
        Intent intent = new Intent(this, NuevaPrenda_int1.class);
        startActivity(intent);
    }

    public void paginaTodasPrendas(View view) {
        Intent intent = new Intent(this, MainActivity.class);
        startActivity(intent);
    }

    public void paginaCambioDatos(View view) {
